    ...
    return {
      ...
      link: function(scope) {
        scope.$watch('current.font', function(newFont, oldFont) {
          ...
          console.log('current.font', newFont);
