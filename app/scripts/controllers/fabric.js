...
define(['angular', 'fabric', 'fabricUtils'], function(angular) {
    'use strict';

    angular.module('bannerAppApp.controllers.FabricCtrl', [])
        .controller('FabricCtrl', function($scope) {
